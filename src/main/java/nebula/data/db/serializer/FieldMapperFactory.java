...
public abstract class FieldMapperFactory<T> implements FieldMapper<T, ResultSet, PreparedStatement> {
//	public final int jdbcType;
	...
	public FieldMapperFactory(String fieldName, String columnName) {
